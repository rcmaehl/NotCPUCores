...
Func _LoadLanguage($sPath = @OSLang)
	...
	Global $_sLang_GameSection        = IniRead($sPath, "Tools", "Games Section"      , "Gaming"          )
	Global $_sLang_GameMode           = IniRead($sPath, "Tools", "Game Mode"          , " Game\n Mode"    )
	Global $_sLang_HAGS               = IniRead($sPath, "Tools", "Hardware Accel"     , " HAGS"           )
	Global $_sLang_HPET               = IniRead($sPath, "Tools", "HPET Tool"          , " HPET"           )
	Global $_sLang_DiskSection        = IniRead($sPath, "Tools", "Disk Section"       , "Disk Health"     )
	...
	Global $_sLang_ReliabilitySection = IniRead($sPath, "Tools", "Reliability Section", "System Info     ")
	...
	Global $_sLang_AllocPhysical    = IniRead($sPath, "Dropdowns", "Physcial Cores"       , "Physical Cores"     )
	;;; Overwrite value if a newer translation
		   $_sLang_AllocPhysical    = IniRead($sPath, "Dropdowns", "Physical Cores"       , $_sLang_AllocPhysical)
